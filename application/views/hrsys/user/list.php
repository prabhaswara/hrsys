...
//    }
    $('#listUser').w2grid({
        ...
        columns: [
			...
			{ field: 'emp_sp_employee_code', caption: 'Employee Code', size: '150px', searchable: true,sortable: true  },
			{ field: 'emp_sp_fullname', caption: 'Employee Name', size: '200px', searchable: true,sortable: true  },
        ...
        onAdd: function (event) {
             $(this).gn_loadmain('{site_url}/hrsys/user/showForm/0');
        },
        onDelete: function (event) {          
            w2ui['listUser'].url = '{site_url}/hrsys/user/delete';
        },
        onLoad: function (event) {
         w2ui['listUser'].url = '{site_url}/hrsys/user/json_list';
        },
        onDblClick: function (event) {
            $(this).gn_loadmain('{site_url}/hrsys/user/showForm/'+event.recid);
